class Ajax {
    ...
    public PostImage = (ruta: string, success: Function, params: string = "", error?: Function):void => {
    ...
    public PostForm = (ruta: string, success: Function, params: FormData , error?: Function):void => {       
    ...
    public PostImageForm = (ruta: string, success: Function, params: FormData, error?: Function):void => {
